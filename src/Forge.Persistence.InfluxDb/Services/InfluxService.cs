...
public class InfluxService : IInfluxService
{
        ...
        where T : class
    {
        ...
        {
            _logger.LogWarning("Cannot add measurement beacuse of not responding db or not correct measurement. Measurement: {Data}", data.Data);
            return false;
        }
        ...
        _logger.LogTrace("Measurement: {Data} has been added to db.", data.Data);
        return true;
    }
